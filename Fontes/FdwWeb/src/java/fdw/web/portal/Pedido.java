...
public class Pedido extends AbstractPageBean {
    ...
    protected SessionBean1 getSessionBean1() {
     ...
     public String hlkAltQuant_action(){
         int selecionado = Integer.parseInt(getValue("#{currentRow.value['codigoPrato']}").toString());
         int quantNova = Integer.parseInt(getValue("#{currentRow.value['quantidade']}").toString());
         getSessionBean1().getCarrinhoCompras().AlteraQuantidade(selecionado, quantNova);
         return null;
     }
